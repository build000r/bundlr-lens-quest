					...
					<div className="sm:col-span-4">
						...
						<div className="mt-2 flex gap-x-4">
							<input
								...
								placeholder="0.00"
								className="p-1 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:outline-0 focus:ring-inset focus:ring-gray-300 sm:text-sm sm:leading-6" />
